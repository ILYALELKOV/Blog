...
const PostFormContainer = ({ className, post: { id, title, imageUrl, content, publishedAt } }) => {
	...
	const onSave = () => {
		...
		dispatch(
			savePostAsync(requestServer, { imageUrl: imageUrlValue, title: titleValue, content: newContent, id })
	...
	return (
		<div className={className}>
			...
			<SpecialPanel
				...
				margin="20px 0"
				editButton={<Icon id="fa-floppy-o" size="21px" onClick={onSave} margin="0 10px 0 0" />}
			/>
